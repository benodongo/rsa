...
public class Home extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatButton btn_details,btn_online;
    private EditText et_old_password,et_new_password;
    private EditText address, pNumber, profession, licence, insurance;
...
//        tv_email = (TextView) findViewById(R.id.tv_email);
        ...
        btn_details=(AppCompatButton)findViewById(R.id.btn_details);
        btn_details.setOnClickListener(this);
        btn_online = (AppCompatButton)findViewById(R.id.btn_online);
        btn_online.setOnClickListener(this);
        layout=(LinearLayout) findViewById(R.id.layout_home);
    }
    ...
    private void details(){
        ...
        pNumber = (EditText)view.findViewById(R.id.pNumber);
        profession = (EditText)view.findViewById(R.id.profession);
        licence = (EditText)view.findViewById(R.id.licence);
